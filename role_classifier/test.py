...
texts = ["Apparently, hiring cats to do human jobs is now a thing!", "Meet Elwood, the red-white tabby who has been seen (quite a lot, in fact) hanging around the main entrance of the Epworth Hospital in Richmond, Melbourne, Australia.", "Chantel Trollip, a Pathologist here at Epworth Hospital, explained that Elwood has been coming to the hospital to chill pretty much every day for around a year now.", "The hospital staff have been feeding him and giving him water.", "He’s even got his own Instagram account, which has over 8,000 followers!"]

img = "./test_image/elwood.jpg"

score, per, candidates = get_clip_score([img], texts)
print(per)